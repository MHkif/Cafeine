    ...
    class EnvoThemes_Demos {
        ...
        public static function ajax_demo_data() {
            ...
            <div id="envo-demo-plugins">
                ...
                <div class="envo-popup-text">
                    ...
                    <div class="envo-required-plugins-wrap">
						...
						<?php if ((isset($required_theme) && !empty($required_theme)) && ($theme->name != $required_theme) ) { ?>
                            <h3><?php esc_html_e('Required Theme', 'envothemes-demo-import'); ?></h3>
							<p><?php echo sprintf( esc_html__('This demo requires a different active theme. Theme %1$sEnwoo%2$s will be activated after the successful import.', 'envothemes-demo-import'), '<a href="' . esc_url('https://enwoo-wp.com/') . '" target="_blank">', '</a>');?></p>
                        <?php } ?>
                    </div>
                ...
                <?php } elseif (defined('ENWOO_PRO_CURRENT_VERSION') && !defined('ENWOO_PRO_STATUS') && $premium['0']['slug'] == 'enwoo-pro') { ?>
                    <div class="envo-button envo-plugins-pro">
				...
				<?php } elseif (defined('ENWOO_PRO_CURRENT_VERSION') && (defined('ENWOO_PRO_STATUS') && ENWOO_PRO_STATUS == 'expired') && $premium['0']['slug'] == 'enwoo-pro') { ?>
                    <div class="envo-button envo-plugins-pro">
        ...
        public function ajax_after_import() {
            ...
            if ($_POST['envo_import_is_xml'] === 'true') {
				...
				$theme = wp_get_theme();
				if ((isset($required_theme) && !empty($required_theme)) && ($theme->name != $required_theme) ) {
